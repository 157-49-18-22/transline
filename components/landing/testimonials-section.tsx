...
const testimonials = [
  {
    quote: "Transline's surveillance solution transformed our campus security. Incident response time dropped by 70%.",
    author: "Rajesh Kumar",
    role: "Head of Security",
    company: "HDFC Bank",
    metric: { value: "70%", label: "Faster response" },
  },
  {
    quote: "The biometric access system they deployed at our facility is flawless. Zero unauthorized access in 2 years.",
    author: "Priya Sharma",
    role: "Operations Director",
    company: "DLF Ltd",
    metric: { value: "0", label: "Breaches in 2 yrs" },
  },
  {
    quote: "Their ANPR system at our toll plaza handles thousands of vehicles daily with incredible accuracy.",
    author: "Anil Mehta",
    role: "Project Manager",
    company: "NHAI",
    metric: { value: "99.8%", label: "ANPR accuracy" },
  },
  {
    quote: "Exceptional post-installation support. Their team resolves issues within hours, not days.",
    author: "Sunita Verma",
    role: "IT Manager",
    company: "Big Bazaar Retail",
    metric: { value: "<2hrs", label: "Support response" },
  },
];
        ...
        <div className="flex items-center justify-between mb-20">
          <div>
            ...
            <h2 className={`text-4xl lg:text-5xl font-display transition-all duration-1000 ${
              ...
              Trusted by clients
              <span className="text-background/40"> across India.</span>
            </h2>
          </div>
