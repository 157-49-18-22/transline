...
const footerLinks = {
  Products: [
    { name: "CCTV & Surveillance", href: "#products" },
    { name: "Biometric Access", href: "#products" },
    { name: "Traffic Management", href: "#products" },
    { name: "IT Infrastructure", href: "#products" },
  ],
  Solutions: [
    { name: "Government & PSU", href: "#" },
    { name: "Banking & Finance", href: "#" },
    { name: "Retail & Malls", href: "#" },
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="py-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-white/30">
            &copy; 2025 Transline Technologies. All rights reserved.
          </p>

          <div className="flex items-center gap-4 text-sm text-white/30">
            <span className="flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-[#163f92]" />
