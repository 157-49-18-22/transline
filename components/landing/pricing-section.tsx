...
const plans = [
  {
    name: "Basic",
    description: "For small businesses & single-site security",
  ...
  {
    name: "Professional",
    description: "For enterprises & multi-site deployments",
    price: { monthly: null, annual: null },
    features: [
      "Full HD / 4K IP cameras",
  ...
  {
    name: "Enterprise",
    description: "For government, smart cities & large campus",
    price: { monthly: null, annual: null },
    features: [
      "Smart city surveillance",
      "Integrated traffic management",
      "Command center setup",
      "Turnstile & boom barriers",
                  ...
                  <ul className="space-y-3 mb-10">
                    {plan.features.map((feature) => (
                      <li key={feature} className="flex items-start gap-3">
                        <Check className="w-4 h-4 text-[#163f92] mt-0.5 shrink-0" />
